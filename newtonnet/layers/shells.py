    ...
    def forward(
        ...
        if neighbor_mask.is_sparse:    # TODO: implement sparse tensors
            ...
            if self.pbc:
                ...
                distances = (distance_vectors + self.epsilon).norm(dim=-1, p=2)    # data_size, n_atoms, n_atoms, 27
                ...
                distances = (distance_vectors + self.epsilon).norm(dim=-1, p=2)    # data_size, n_atoms, n_atoms    # TODO: remove epsilon and replace with mask
