...
model = NewtonNet(n_basis=settings['model']['resolution'],
               ...
               use_data_normalizer=settings['model']['normalize_atomic'],
               invariant_node_output_derivative=settings['model']['requires_dr'],
               device=device[0],
               create_graph=True,
               share_interactions=settings['model']['shared_interactions'],
...
trainer = Trainer(model=model,
                  ...
                  device=device,
                  settings_path=settings['general']['me'],
                  output_path=settings['general']['output'],
                  script_path=settings['general']['driver'],
